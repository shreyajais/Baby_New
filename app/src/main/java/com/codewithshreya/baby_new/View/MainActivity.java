    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openTeachersActivityBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(com.codewithshreya.baby_new.View.MainActivity.this, com.codewithshreya.baby_new.View.ItemsActivity.class);
                startActivity(i);
            }
        });
        openUploadActivityBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(com.codewithshreya.baby_new.View.MainActivity.this, com.codewithshreya.baby_new.View.UploadActivity.class);
                startActivity(i);
            }
        });
