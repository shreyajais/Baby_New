...
public class ItemsActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerAdapter (com.codewithshreya.baby_new.View.ItemsActivity.this, mRecipes);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(com.codewithshreya.baby_new.View.ItemsActivity.this);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(com.codewithshreya.baby_new.View.ItemsActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(int position) {
        ...
        String[] RecipeData={clickedRecipe.getName(),clickedRecipe.getDescription(),clickedRecipe.getImageUrl()};
    ...
    public void onDeleteItemClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void> () {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(com.codewithshreya.baby_new.View.ItemsActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
